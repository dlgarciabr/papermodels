...
-- AlterTable
ALTER TABLE "Item" ADD COLUMN     "integrationUrl" TEXT,
DROP COLUMN "status",
...
-- AddForeignKey
ALTER TABLE "ItemIntegrationLog" ADD CONSTRAINT "ItemIntegrationLog_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "Item"("id") ON DELETE CASCADE ON UPDATE CASCADE;
