/*
  ...
  - The values [pendingReading,pendingSimulation,simulated] on the enum `UrlIntegrationStatus` will be removed. If these variants are still used in the database, this will fail.
...
-- AlterEnum
BEGIN;
CREATE TYPE "UrlIntegrationStatus_new" AS ENUM ('readingPending', 'readingDone', 'simulationPending', 'simulationDone', 'pending', 'done');
