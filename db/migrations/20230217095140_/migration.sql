/*
  ...
  - Added the required column `key` to the `IntegrationLog` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "IntegrationLog" ADD COLUMN     "key" TEXT NOT NULL;
