/*
  ...
  - Added the required column `key` to the `IntegrationSetup` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "IntegrationSetup" ADD COLUMN     "key" TEXT NOT NULL;
